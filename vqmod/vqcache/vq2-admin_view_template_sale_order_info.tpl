  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <div id="tab-history" class="vtabs-content">
        <div id="history"></div>
        <table class="form">
<tr><td><?php echo "Tracking Number:" ?></td><td><input type="text" value="" id="tracking_number"></td></tr>
          <tr>
            <td><?php echo $entry_order_status; ?></td>
            <td>
              <input type="hidden" name="old_order_status_id" value="<?php echo $order_status_id; ?>" id="old_order_status_id" />
              <select name="order_status_id" id="order_status_id_selector">
...
<script type="text/javascript"><!--
    function orderStatusChange(){
        var status_id = $('select[name="order_status_id" id="order_status_id_selector"]').val();
    ...
    $('select[name="order_status_id" id="order_status_id_selector"]').change(function(){orderStatusChange();});
//--></script>
<script type="text/javascript"><!--
