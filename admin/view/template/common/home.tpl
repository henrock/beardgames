...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div class="missing-weight">
        <div class="dashboard-heading">Products in stock that is missing weight (this should be empty!)</div>
        <div class="dashboard-content">
          <table>
            <?php foreach($products_missing_weight as $product) { ?>
            <tr>
              <td><?php echo $product['name']; ?></td>
              <td><a href="<?php echo $product['edit_link']; ?>">edit</a></td>
            </tr>
            <?php } ?>
          </table>
        </div>
      ...
      <div class="missing-weight">
        <div class="dashboard-heading">Products in stock that is missing seo name (this should be empty!)</div>
        <div class="dashboard-content">
          <table>
            <?php foreach($products_missing_seo_name as $product) { ?>
            <tr>
              <td><?php echo $product['name']; ?></td>
              <td><a href="<?php echo $product['edit_link']; ?>">edit</a></td>
            </tr>
