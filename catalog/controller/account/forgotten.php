...
class ControllerAccountForgotten extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$htmlMessage  = '<img src="http://staging.beardgames.se/image/data/logo.png" width="400" alt="%s" /><br/><br/>';
			$htmlMessage .= sprintf($this->language->get('text_greeting'), $this->config->get('config_name')) . '<br/><br/>';
			$htmlMessage .= $this->language->get('text_password') . "<b>" . $password . "</b>";
