...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" id="cart_form" method="post" enctype="multipart/form-data">
    <div class="cart-info">
      <table>
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr<?php echo (!$product['stock']) ? 'class="stock"' : ''; ?>>
            <td class="image">
              ...
              <?php } else { ?>
              <a href="<?php echo $product['href']; ?>"><img src="<?php echo $no_image; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" /></a>
              <?php } ?>
            </td>
            <td class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a><br/>
              Art nr: <?php echo $product['model']; ?>
              ...
              &nbsp;
              <a onclick="$('#cart_form').submit();" title="<?php echo $button_update; ?>" class="button"><i class="fa fa-refresh"></i></a>
              &nbsp;
              <a href="<?php echo $product['remove']; ?>" title="<?php echo $button_remove; ?>" class="button"><i class="fa fa-times"></i></a></td>
            <td class="price"><?php echo $product['price']; ?> kr</td>
            <td class="total"><?php echo $product['total']; ?> kr</td>
          </tr>
          <?php } ?>
  ...
  <div class="buttons">
    <div class="right"><a href="<?php echo $checkout; ?>" class="button"><i class="fa fa-arrow-circle-right"></i> <?php echo $button_checkout; ?></a></div>
    <div class="right"><a href="<?php echo $continue; ?>" class="button"><i class="fa fa-arrow-circle-right"></i> <?php echo $button_shopping; ?></a></div>
  </div>
