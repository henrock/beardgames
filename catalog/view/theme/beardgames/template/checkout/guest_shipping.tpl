<div class="clearfix checkout-header-group">
	<h1 class="checkout-header-left">
		<i class="fa fa-truck"></i> Gästkassa (Leveransadress)
	</h1>
...
<p>Ange leveransadress till gästkassan.</p>
<div class="checkout-box left">

<table class="form register-form" id="shipping-address">
  <tr>
  ...
  <tr>
    <td><span class="required"><i class="fa fa-exclamation-circle"></i></span> <?php echo $entry_postcode; ?></td>
  ...
  <tr>
	...
	<div class="buttons">
	  <a id="button-guest-shipping" class="button"><i class="fa fa-arrow-circle-right"></i> <?php echo $button_continue; ?></a></div>
	</div>
</div>
