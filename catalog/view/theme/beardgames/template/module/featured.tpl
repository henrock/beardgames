        ...
        <div class="box-product <?php if($key == 0) echo "first"; ?>">
          <a href="<?php echo $product['href']; ?>">
			...
			<?php if($product['quantity'] > 0) { ?>
              <i class="fa fa-cubes fa-2x available stock featured-stock" title="Finns i lager"></i>
            <?php } else { ?>
              <i class="fa fa-cubes fa-2x unavailable stock featured-stock" title="Finns ej i lager"></i>
            <?php } ?>
          ...
          <div class="name">
		  <a href="<?php echo $product['href']; ?>" title="<?php echo $product['fullname']; ?>"><?php echo $product['name']; ?></a></div>          
          <?php /*if ($product['rating']) { ?>
          <div class="rating"><img src="catalog/view/theme/default/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" /></div>
          <?php }*/ ?>
          <div class="cart">
			<a onclick="addToCart('<?php echo $product['product_id']; ?>', 1, this);" class="button"><i class="fa fa-shopping-cart"></i> KÖP</a>
          </div>
